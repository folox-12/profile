...
<template>
    <nav>
        <ul class="flex gap-2 items-center">
            <li>
                <router-link to="/works/" class="text-cyan-400 hover:underline hover:underline-offset-4">
                    {{ t('general.works') }}
                </router-link>
            </li>
            ...
            <li>
                ...
                <span v-if="currentProject?.year" class="inline-block bg-orange-100 text-stone-500 rounded-sm dark:bg-slate-400 dark:text-zinc-950 ml-2 p-1">
                    {{ currentProject.year}}
                </span>
            </li>
        </ul>
